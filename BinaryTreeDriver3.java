...
class BinaryTreeDriver3
{
	public static void main(String[] args) {
		...
		btree.root.right.left.left.left=new BinaryTree.Node<Character>('L');
		btree.root.right.left.left.right=new BinaryTree.Node<Character>('M');
		btree.root.right.left.right.left=new BinaryTree.Node<Character>('N');
